                ...
                <div className="banner-upload md:grid lg:grid-cols-4 grid-cols-1 lg:gap-x-16 lg:pt-9">
                    ...
                    <div className="col-span-2">
                        <div className="banner-text mb-4">
                            <p className="text-center font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl">Convert an image PNG to JPG</p>
                            <p className=" text-center md:mt-6 mt-3 md:text-lg text-sm text-[#706f73]">Effortlessly convert your images PNG to JPG using our free online image converter.</p>
                        </div>
