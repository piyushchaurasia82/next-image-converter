...
const ConvertIco = () => {
    return (
        ...
        <Head>
            ...
            <meta name="description" content="Switch your images to the ICO format, and you can even create a favicon.ico using our converter." />
            <link rel="canonical" href="https://nextconvert.in/convert-to-ico" />
                ...
                <div className="banner-upload md:grid lg:grid-cols-4 grid-cols-1 lg:gap-x-16 lg:pt-9">
                    ...
                    <div className="col-span-2">
                        <div className="banner-text mb-4">
                            ...
                            <h2 className=" text-center md:mt-6 mt-3 md:text-lg text-sm text-[#706f73]">Switch your images to the ICO format, and you can even create a favicon.ico using our converter.</h2>
                        </div>
