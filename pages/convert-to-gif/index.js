...
const ConvertGif = () => {
    return (
        <>
        <Head>
            <title>Convert files to GIF</title>
            <meta name="description" content="Convert images to the GIF format or even turn videos into animated GIFs with our versatile online converter." />
            <link rel="canonical" href="https://nextconvert.in/convert-to-gif" />
                ...
                <div className="banner-upload md:grid lg:grid-cols-4 grid-cols-1 lg:gap-x-16 lg:pt-9">
                    ...
                    <div className="col-span-2">
                        <div className="banner-text mb-4">
                            <h1 className="text-center font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl">Convert files to GIF</h1>
                            <h2 className=" text-center md:mt-6 mt-3 md:text-lg text-sm text-[#706f73]">Convert images to the GIF format or even turn videos into animated GIFs with our versatile online converter.</h2>
                        </div>
