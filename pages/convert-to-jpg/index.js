...
const ConvertJpg = () => {
    return (
        <>
        <Head>
            <title>Online image converter to JPEG</title>
            <meta name="description" content="Convert files from over 120 formats into high-quality JPG images, with the added option to apply digital effects." />
            <link rel="canonical" href="https://nextconvert.in/convert-to-jpg" />
                ...
                <div className="banner-upload md:grid lg:grid-cols-4 grid-cols-1 lg:gap-x-16 lg:pt-9">
                    ...
                    <div className="col-span-2">
                        <div className="banner-text mb-4">
                            <h1 className="text-center font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl">Online image converter to JPEG</h1>
                            <h2 className=" text-center md:mt-6 mt-3 md:text-lg text-sm text-[#706f73]">Convert files from over 120 formats into high-quality JPG images, with the added option to apply digital effects.</h2>
                        </div>
