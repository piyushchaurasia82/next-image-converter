...
const ConvertPng = () => {
    return (
        ...
        <Head>
            ...
            <meta name="description" content="Transform images from various formats into PNG files, with the ability to add digital effects for enhanced visuals." />
            <link rel="canonical" href="https://nextconvert.in/convert-to-png" />
        </Head>
                ...
                <div className="banner-upload md:grid lg:grid-cols-4 grid-cols-1 lg:gap-x-16 lg:pt-9">
                    ...
                    <div className="col-span-2">
                        <div className="banner-text mb-4">
                            <h1 className="text-center font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl">Convert image to PNG</h1>
                            <h2 className=" text-center md:mt-6 mt-3 md:text-lg text-sm text-[#706f73]">Transform images from various formats into PNG files, with the ability to add digital effects for enhanced visuals.</h2>
                        </div>
