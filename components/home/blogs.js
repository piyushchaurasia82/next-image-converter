        ...
        <div className="mt-14 2xl:w-10/12 lg:w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="md:grid grid-cols-4 gap-x-16 mt-9">
                <div className="col-span-1">
                    <img className="w-full" alt="Free Online Image Converter" title="Free Online Image Converter" src="/dummy/ads.png"/>
                </div>
                <div className="col-span-2 flex items-center">
                    ...
                    <div className="mt-20 flex flex-wrap items-center ">
                        <div className=" md:w-6/12 md:px-8">
                            <img className="w-full" title="Free Online Image Converter" alt="Free Online Image Converter" src="/dummy/blogs.png"/>
                        </div>
