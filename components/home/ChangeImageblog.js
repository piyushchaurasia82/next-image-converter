    ...
    return(
        ...
        <div className="banner-text">
            <div className="grid md:grid-cols-2">
                <div>
                <h1 className="font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl text-[#322354]">Easily convert the image file format</h1>
                <h2 className=" mt-6">
            ...
            <div className="grid md:grid-cols-2 mt-20">
                ...
                <div>
                <h1 className="font-harmony-bold 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl text-[#322354]">Transform any image into a creative asset</h1>
                    <h2 className="mt-6">
                    ...
                    <br/>
                    <h2>Experience the convenience of handling all your image conversion needs in one place. No need to worry about format compatibility or quality loss—NextConvert has you covered. Give it a try and see how easy managing your image files can be!</h2>
               </div>
            </div>
        </div>
    </div>
